# IO.Swagger - the C# library for the PED Test API
...
------------ | ------------- | ------------- | -------------
*AdminApi* | [**AddInventory**](docs/AdminApi.md#addinventory) | **POST** /inventory | adds an inventory item
*AdminApi* | [**SearchInventory**](docs/AdminApi.md#searchinventory) | **GET** /inventory | searches inventory
*SharedApi* | [**ReasonCodes**](docs/SharedApi.md#reasoncodes) | **GET** /reasoncodes | Get all Reason Codes
*SharedApi* | [**States**](docs/SharedApi.md#states) | **GET** /states | Get all States
