...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class States :  IEquatable<States>, IValidatableObject
    {
        /// <summary>
        ...
        public States(decimal? stateId = default(decimal?), string stateName = default(string), string stateCode = default(string))
        {
        ...
        {
            return this.Equals(input as States);
        }

        /// <summary>
        /// Returns true if States instances are equal
        /// </summary>
        /// <param name="input">Instance of States to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(States input)
        {
            if (input == null)
                return false;
